...
from app.api.routes.settlements import views as settlements_views
...
api_router.include_router(settlements_views.router, prefix="/settlements", tags=["settlements"])
